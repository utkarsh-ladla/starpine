...
function Footer() {
  ...
  return (
    <footer id="footer-element" className="bg-black min-h-[650px] text-gray-400 py-16 text-center relative overflow-hidden">
      ...
      <div className="w-full px-6 gap-11 relative z-20">
        ...
        {/* Navigation Links */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 mx-auto text-left z-50">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/content" className="hover:text-white transition-colors duration-200">App Devvelopment</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="tel:817.332.4600" className="hover:text-white transition-colors duration-200">+91 9546264595</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[350px] overflow-hidden z-0">
            <div className="relative h-full group">
              ...
              <div className={`absolute left-1/2 transform -translate-x-1/2 transition-all duration-1000 ease-out ${isVisible ? 'bottom-[-40%] group-hover:bottom-0' : 'bottom-[-60%]'
                }`}>
