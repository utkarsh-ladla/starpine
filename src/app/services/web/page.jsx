...
//   return (
//     <button
//       className={`px-8 py-4 bg-gradient-to-r from-gray-500   text-white  font-semibold rounded-2xl hover:from-gray-700 hover:to-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl ${className}`}
//       {...props}
//     >
//       {children}
//     </button>
...
//       }`}
//     >
//       <div className="w-16 h-16 bg-gradient-to-r from-gray-500   text-white rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
...
//       }`}
//     >
//       <div className="w-20 h-20 bg-gradient-to-r from-gray-500   text-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
...
//       <section className="relative bg-gradient-to-r from-gray-500   text-white h-[80vh] flex flex-col justify-center items-center text-center px-6">
...
//         <div className="mb-12">
//           <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-gray-500   text-white bg-clip-text ">
...
//             <div className="w-16 h-16 bg-gradient-to-r from-gray-500   text-white rounded-full flex items-center justify-center mx-auto mb-4">
...
//           <h2 className="text-4xl font-bold mb-16 bg-gradient-to-r from-gray-500   text-white bg-clip-text ">
...
//       {/* CTA */}
//       <section className="py-20 bg-gradient-to-r from-gray-500   text-white text-center relative overflow-hidden">
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50 text-slate-900 overflow-hidden">
      ...
      <section className="relative bg-gradient-to-r from-gray-500 to-gray-700 text-white h-[80vh] flex flex-col justify-center items-center text-center px-6">
        ...
        <Button
          size="lg"
          className="rounded-xl bg-white text-gray-700 font-semibold hover:bg-gray-100"
        >
          Get Started
        </Button>
      </section>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto text-center">
        <div className="mb-12">
          <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-gray-500 to-gray-700 text-transparent bg-clip-text">
            Why Choose Our Services?
          </h2>
          <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            From innovative startups to established enterprises, we help brands
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="text-center">
            <div className="w-16 h-16 bg-gradient-to-r from-gray-500 to-gray-700 text-white rounded-full flex items-center justify-center mx-auto mb-4">
              <Award className="text-white" size={28} />
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-16 bg-gradient-to-r from-gray-500 to-gray-700 text-transparent bg-clip-text">
            What Our Clients Say
          </h2>
